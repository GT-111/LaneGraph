        ...
        for ilon in range(blocks[1]):
            ...
            for node_id, node_info in OSMMap.nodedict.iteritems():
                ...
                for nid in node_info["to"].keys() + node_info["from"].keys():
                    ...
                    x1 = (
                        int(
                            (lon1 - subregion[1]) / (subregion[3] - subregion[1]) * 4096
                        )
                        - sc
                    )
                    y1 = (
                        int(
                            (subregion[2] - lat1) / (subregion[2] - subregion[0]) * 4096
                        )
                        - sr
                    )
                    ...
                    x2 = (
                        int(
                            (lon2 - subregion[1]) / (subregion[3] - subregion[1]) * 4096
                        )
                        - sc
                    )
                    y2 = (
                        int(
                            (subregion[2] - lat2) / (subregion[2] - subregion[0]) * 4096
                        )
                        - sr
                    )
                    ...
                    if (x1 >= 0 and x1 <= 4096 and y1 >= 0 and y1 <= 4096) or (
                        x2 >= 0 and x2 <= 4096 and y2 >= 0 and y2 <= 4096
                    ):
