...
sys.path.append(os.path.join(os.path.dirname(os.path.dirname(sys.path[0])),'code','cnnmodels'))
sys.path.append(os.path.join(os.path.dirname(os.path.dirname(sys.path[0])),'code','framework'))
sys.path.append(os.path.join(os.path.dirname(os.path.dirname(sys.path[0])),'code'))
...
class Train(TrainingFramework):
	def __init__(self):
		...
		dataset_split = json.load(open(r".\code\split_all.json"))
